...
/** Disease · Diagnosis (optional) · Outcome (optional) · Pending (only if unsynced) */
export default function StatusChips({ diseaseId, diagnosis, outcome, pending, testid }) {
  ...
  return (
    <div className="flex min-w-0 flex-wrap items-center gap-1.5" data-testid={testid}>
      ...
      {pending && (
        <Badge variant="outline" className={`${chipCls} border-orange-300 bg-orange-50 text-orange-800`}>
          Pending
        </Badge>
      )}
    </div>
